...
- **(F) and (G) do not agree, and that is the result.** The pair is co-localized in endothelial (11.1% of cells, above the 2% gate), but the cell-level correlation is 0.07 and the background-matched empirical P is 0.009, so the correlation criterion of the reference framework is **not** met in this tissue.
