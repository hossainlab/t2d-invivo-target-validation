...
#let badge(body, bg: accent-bg, text-color: primary) = {
  box(
    ...
    outset: 0pt,
    baseline: 0%,
    text(size: 7.5pt, weight: "bold", fill: text-color, body)
  )
}
...
#block(
  ...
  [
    #grid(
      ...
      gutter: 10pt,
      [
        #text(size: 18pt, weight: "bold", fill: dark)[Executive Summary & Central Conclusion]
        
        #v(2pt)
        #text(size: 10.5pt, weight: "medium", fill: secondary)[
  ...
  #block(
    ...
    [
      #grid(
        ...
        gutter: 3pt,
        [
          #text(weight: "bold", size: 8pt, fill: primary)[Stage 1: Bulk]\
          #text(size: 7pt, fill: rgb("475569"))[1,648 DEGs ∩\ WGCNA ∩ Set\ *(8 Candidates)*]
        ],
        [#text(fill: rgb("94a3b8"), size: 10pt)[$arrow.r$]],
        [
          #text(weight: "bold", size: 8pt, fill: primary)[Stage 2: Topology]\
          #text(size: 7pt, fill: rgb("475569"))[AMPK Signaling\ (hsa04152)\ *(Anchored Axis)*]
        ],
        [#text(fill: rgb("94a3b8"), size: 10pt)[$arrow.r$]],
        [
          #text(weight: "bold", size: 8pt, fill: primary)[Stage 3: scRNA]\
          #text(size: 7pt, fill: rgb("475569"))[Liver Cholang. &\ Kidney Endoth.\ *(Co-Localization)*]
        ],
        [#text(fill: rgb("94a3b8"), size: 10pt)[$arrow.r$]],
        [
          #text(weight: "bold", size: 8pt, fill: primary)[Stage 4: ML]\
          #text(size: 7pt, fill: rgb("475569"))[LASSO / RF / SVM\ *(Multi-Variable\ Predictability)*]
        ],
        [#text(fill: rgb("94a3b8"), size: 10pt)[$arrow.r$]],
        [
          #text(weight: "bold", size: 8pt, fill: primary)[Stage 5: MR]\
          #text(size: 7pt, fill: rgb("475569"))[cis-eQTL MR\ 74k T2D Cases\ *(Genetics)*]
        ]
      )
      #v(4pt)
      #line(length: 100%, stroke: 0.5pt + rgb("e2e8f0"))
      #v(2pt)
      #text(weight: "bold", size: 8pt, fill: dark)[
...
#align(center)[
  #block(
    ...
    inset: (x: 12pt, y: 7pt),
    [
      #text(size: 9.5pt, weight: "bold", fill: primary)[
  ...
  #block(
    ...
    [
      #grid(
        ...
        gutter: 4pt,
        [
          #block(fill: tier3-bg, stroke: 1pt + rgb("d8b4fe"), radius: 4pt, inset: 5pt, width: 75%)[
            #text(weight: "bold", size: 8.5pt, fill: tier3-text)[UPSTREAM MECHANISM (Tier 3)]\
            #text(size: 7.5pt, fill: dark)[*p-AMPKα (PRKAA1/2) · SIRT1 · STK11 (LKB1)*\ (Phosphorylation / Post-Translational Node)]
          ]
        ],
        [#text(fill: rgb("94a3b8"), size: 8pt)[$arrow.b$]],
        [
          #grid(
            columns: (1fr, 1fr),
            gutter: 10pt,
            [
              #block(fill: tier1-bg, stroke: 1pt + rgb("86efac"), radius: 4pt, inset: 5pt, width: 100%)[
                #text(weight: "bold", size: 8.5pt, fill: tier1-text)[PRIMARY TARGET 1 (Tier 1)]\
                #text(weight: "bold", size: 8pt, fill: dark)[PPARGC1A (PGC-1α)]\
                #text(size: 7pt, fill: rgb("475569"))[Master Metabolic Co-activator\ Human T2D: $log_2"FC" = -0.61$\ Mouse Cholangiocytes: $P = 0.011$ (ML Rank 3)]
              ]
            ],
            [
              #block(fill: tier1-bg, stroke: 1pt + rgb("86efac"), radius: 4pt, inset: 5pt, width: 100%)[
                #text(weight: "bold", size: 8.5pt, fill: tier1-text)[PRIMARY TARGET 2 (Tier 1)]\
                #text(weight: "bold", size: 8pt, fill: dark)[CCND1 (Cyclin D1)]\
                #text(size: 7pt, fill: rgb("475569"))[Pathway Output / Stress Readout\ Human T2D: $log_2"FC" = +0.80$\ Mouse Kidney EC: $P = 1.2 times 10^(-6)$ (Replicated)]
              ]
            ]
          )
        ],
        ...
        [
          #grid(
            ...
            gutter: 10pt,
            [
              #block(fill: tier2-bg, stroke: 1pt + rgb("fde68a"), radius: 4pt, inset: 4.5pt, width: 100%)[
                #text(weight: "bold", size: 7.5pt, fill: tier2-text)[READOUT: GLYCOLYSIS (Tier 2)]\
                #text(size: 7.5pt, fill: dark)[*PFKFB3* (FDR = 0.042)]
              ]
            ],
            [
              #block(fill: tier2-bg, stroke: 1pt + rgb("fde68a"), radius: 4pt, inset: 4.5pt, width: 100%)[
                #text(weight: "bold", size: 7.5pt, fill: tier2-text)[READOUT: CELL-CYCLE ARREST (Tier 2)]\
                #text(size: 7.5pt, fill: dark)[*CDKN1A (p21) · BAX · PHLDA3*]
              ]
            ]
          )
        ]
...
#block(
  ...
  [
    #grid(
      ...
      gutter: 14pt,
      [
        #text(weight: "bold", size: 9pt, fill: primary)[Experimental Groups (n = 8 per group)]
        #v(3pt)
      ...
      [
        #text(weight: "bold", size: 9pt, fill: primary)[Molecular & Phenotypic Endpoints]
        #v(3pt)
