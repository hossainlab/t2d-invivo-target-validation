...
- **Neither Tier 1 target is causal.** CCND1 OR 1.033, P = 0.55; PPARGC1A OR 0.983, P = 0.16. `docs/target_selection.md` nominates these two on expression and cell-type evidence; MR does not support either, and that disagreement is reported rather than smoothed over.
...
- **FDR is recomputed over the 9 genes of the selected map,** by the same rule scripts 19/20b use: Benjamini-Hochberg over one primary estimate per gene. The analysis this figure reports is MR of hsa04152, so that is the family the correction belongs to. Over all 24 instrumented genes the same two exposures give q = 2.16E-07 and 1.14E-02; correcting within the map changes the q values, not which genes clear 0.05.
...
| Map genes at FDR < 0.05 | 2 (SREBF1 q = 8.11E-08, SIRT1 q = 4.26E-03) |
| Same genes, q over all 24 instrumented genes | SREBF1 q = 2.16E-07, SIRT1 q = 1.14E-02 |
...
| Tier 1 targets | CCND1 OR 1.033, P = 0.55; PPARGC1A OR 0.983, P = 0.16 |
