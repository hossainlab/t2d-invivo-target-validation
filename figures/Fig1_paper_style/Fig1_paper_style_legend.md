...
- **(E) has 14 modules plus grey, not seven,** and the strongest is **red** (r = 0.65) rather than the paper's blue (r = 0.83). Control is the complement of T2D, so its column is the exact negative with an identical P, exactly as in the reference.
- **(F) shows the red module** and this project's hub thresholds (|kME| > 0.7, |GS| > 0.2, decision M10), not the paper's 0.7 / 0.7.
...
| Strongest module | red, r = 0.65, P = 2.2e-04 |
