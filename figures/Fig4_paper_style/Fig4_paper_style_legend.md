...
- **Nothing separates the groups in the independent cohort.** The best external AUC is 0.64 (Score), 95% CI 0.33-0.96, and every confidence interval includes 0.5. LASSO is below chance at 0.43. This is a negative result and should be reported as one.
- **(C) ranks genes that the models then fail to use.** VSNL1 and PPARGC1A are selected in 100% and 97% of LASSO folds, which says they are the most stable features of a panel that does not generalise, not that they are validated markers.
